...
# a - minor radius, c - major radius 
data_torus = torus(n=num_points, c=5, a=1)
...
# sphere_landscaper.start is None
sphere_landscaper.fit(dgms_sphere)

sphere_landscaper.fit(dgms_torus)
